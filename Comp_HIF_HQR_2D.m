...
for i = 1:cases
    ...
    [F, rk] = hifie2my(Afun,xx',occ,rank_or_tol);
...
axis square;
saveas(fig, "./comp/2D/kernel" + kernel + "/apptime_" + func_name + ".png");
hold off;
...
saveas(fig, "./comp/2D/kernel" + kernel + "/soltime_" + func_name + ".png");
hold off;
...
title('Forward error');
legend(h, 'HIF', 'HQR');
saveas(fig, "./comp/2D/kernel" + kernel + "/apperr_" + func_name + ".png");
hold off;
...
legend(h, 'HIF', 'HQR');
saveas(fig, "./comp/2D/kernel" + kernel + "/solerr_"+ func_name + ".png");
hold off;
...
legend(h, 'A', 'ATA');
saveas(fig, "./comp/2D/kernel" + kernel + "/conda_"+ func_name + ".png");
hold off;
...
title('Error of BF');
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./comp/2D/kernel" + kernel + "/bferr_"+ func_name + ".png");
hold off;
...
saveas(fig, "./comp/2D/kernel" + kernel + "/rank_"+ func_name + ".png");
hold off;
...
legend(h, 'HIF', 'HQR');
saveas(fig, "./comp/2D/kernel" + kernel + "/pcgerr_"+ func_name + ".png");
hold off;
...
legend(h, 'HIF', 'HQR');
saveas(fig, "./comp/2D/kernel" + kernel + "/iters_" + func_name + ".png");
hold off;
