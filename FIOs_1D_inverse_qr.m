...
axis square;
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/apptime_" + func_name + ".png");
...
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/soltime_" + func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/apperr_" + func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/solerr_"+ func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/conda_"+ func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/condata_" + func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/bferr_"+ func_name + ".png");
...
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/rank_"+ func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/pcgerr_"+ func_name + ".png");
...
hold off;
% legend(h, 'App time', 'N log N', 'N log^2 N');
saveas(fig, "./results/hqr/1D/kernel" + kernel + "/iters_" + func_name + ".png");
